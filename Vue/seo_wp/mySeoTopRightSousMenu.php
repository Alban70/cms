    ...
    <div id="h_hm_crm_nav_bar3" class="hpTop" style="background-color: #1776d2; !important;">
        <div id="hamburger" class="content" style="width: 98%; !important;">
            <div class="content" style="height: 100%; !important;">
                <h1 id="txtMenu" class="txt_menu_white_centre" style="color:white; padding: 0 0 0 4vh; !important;">SEO</h1>
                <ul id="navPrest" class="menu-menu-seo-container ul contentCacher">
                    <li>
                        <div class="fonct_txt">
                            <a id="c"  href="<?php echo \Lib\Application::$racine; ?>auditSeo"   style="color:white; !important;">Audit</a>
                        </div>
                    </li>
                    <li>
                        <div class="fonct_txt">
