<nav class="myheader2">
    <div id="h_hm_crm_nav_bar3" class="hpTop" style="background-color: #4A89DC; !important;">
        <div id="hamburger" class="content" style="width: 98%; !important;">
            <div class="content" style="height: 100%; !important;">
                <h1 id="txtMenu" class="txt_menu_baseline" style="color:white;font-size: 3.2vh; !important;">DES SPÉCIALISTE A VOTRE SERVICE</h1>
            </div>
        </div>
        <div id="cross" class="contentCacher">
            <ul id="menuID" class="menu-menu-header-container ul">
                ...
                <li>
                    <a id="referencement">Seo</a>
                    <ul >
                        <li><a href="<?php echo \Lib\Application::$racine; ?>referencementNaturel">Réferencement naturel</a></li>
                        <li><a href="<?php echo \Lib\Application::$racine; ?>Autorité">Autorité nom de domaine</a></li>
                        <li><a href="<?php echo \Lib\Application::$racine; ?>Autorité">Points de contrôle</a></li>
                        <li><a href="<?php echo \Lib\Application::$racine; ?>methodologie">Méthodologie</a></li>
                        <li><a href="<?php echo \Lib\Application::$racine; ?>auditSeo">Prestations</a></li>
                    </ul>
                </li>
                ...
                <li><a href="<?php echo \Lib\Application::$racine; ?>FormationSeo">Formation</a></li>
                <li><a href="<?php echo \Lib\Application::$racine; ?>Seowordpress">Wordpress</a></li>
                <!--<li id="ref2">
                    <a>Formation</a>
                    <ul>
                ...
                <li><a href="<?php echo \Lib\Application::$racine; ?>Connexion">Connexion</a></li>
            </ul>
        </div>
