<div class="myheader2">
        ...
        <div id="hamburger" class="hamburger">
            <div class="menu-menu-seo-container">
                <ul class="menu-menu-seo-container ul">
                    <li>
                        <a href="<?php echo \Lib\Application::$racine; ?>referencementNaturel" style="color: #ffc107; !important;">Seo</a>
                    </li>
                    <li>
                            <a href="<?php echo \Lib\Application::$racine; ?>auditSeo" style="color: #ffc107; !important;">Audit</a>
                    </li>
                    <li>
                        <a href="<?php echo \Lib\Application::$racine; ?>auditseoonpage" style="color: #ffc107; !important;">PageRank</a>
                    </li>
                    <li>
                            <a href="<?php echo \Lib\Application::$racine; ?>accompagnementSeo" style="color:white; !important;">Prestation</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    //include __DIR__ . '/mySeoAuditHeader2PrestationDesktopBase.php';
