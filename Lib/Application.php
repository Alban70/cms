...
abstract class Application
{
    ...
    //STATIC public $racine = '/seo-web/Web/';
    STATIC public $racine = '/cms/Web/';
    STATIC public $template = '/seo-web/Vue/';
    STATIC public $images = '/seo-web/Web/images/';

    const RACINE_PO = '/seo-web/Web/';
    const TEMPLATE = '/seo-web/Vue/';
